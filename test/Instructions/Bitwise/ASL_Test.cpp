...
TEST_F(ASL_Test, ASL_ZeroPage_OffsetX)
{
    // Given
...
TEST_F(ASL_Test, ASL_ZeroPage_OffsetX_Wrapping)
{
    // Given
    const uint32_t CYCLES = 6;
...
TEST_F(ASL_Test, ASL_Absolute_OffsetX)
{
    // Given
