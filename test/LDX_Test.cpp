...
TEST_F(LDX_Test, NEW_LDA_Imediatate)
{
    // Given
...
TEST_F(LDX_Test, NEW_LDA_ZeroPage)
{
    // Given
...
TEST_F(LDX_Test, NEW_LDA_ZeroPage_OffsetX)
{
    // Given
    processor.RegX = 0x5;
...
TEST_F(LDX_Test, NEW_LDA_ZeroPage_OffsetX_Wrapping)
{
    // Given
    processor.RegX = 0xFF;
    memory[0xFFFC] = INS_LDA_ZPX;
...
TEST_F(LDX_Test, NEW_LDA_Absolute)
{
    // Given
...
TEST_F(LDX_Test, NEW_LDA_Absolute_OffsetX)
{
    // Given
    processor.RegX = 0x64;
...
TEST_F(LDX_Test, NEW_LDA_Absolute_OffsetX_CrossPage)
{
    // Given
    processor.RegX = 0xCC;
    memory[0xFFFC] = INS_LDA_ABX;
...
TEST_F(LDX_Test, NEW_LDA_Absolute_OffsetY)
{
    // Given
    processor.RegY = 0x32;
...
TEST_F(LDX_Test, NEW_LDA_Absolute_OffsetY_CrossPage)
{
    // Given
    processor.RegY = 0xFF;
    memory[0xFFFC] = INS_LDA_ABY;
...
TEST_F(LDX_Test, NEW_LDA_Indirect_OffsetX)
{
    // Given
    processor.RegX = 0x2F;
...
TEST_F(LDX_Test, NEW_LDA_Indirect_OffsetY)
{
    // Given
    processor.RegY = 0xAC;
...
TEST_F(LDX_Test, NEW_LDA_Indirect_OffsetY_CrossPage)
{
    // Given
    processor.RegY = 0xE1;
    memory[0xFFFC] = INS_LDA_IDY;
